...
RSpec.describe User, type: :model do
  ...
  describe 'ユーザー新規登録' do
    context '新規登録がうまくいくとき' do
      it "name,email,password,password_confirmation,last_name_kanzi,first_name_kanzi,last_name_kana,first_name_kana,birthdayか存在すれば登録できる" do
    ...
    context '新規登録がうまくいかないとき' do
      ...
      it "passwordが存在してもpassword_confirmationが空では登録できない" do
        ...
        @user.valid?
        expect(@user.errors.full_messages).to include("Password_confirmation dosen't math Password")
      end
      it "last_name_kanziが空では登録できない" do
        @user.last_name_kanzi = ""
        @user.valid?
        expect(@user.errors.full_messages).to include("Last_name_kanzi can't be blank")
      end
      it "first_name_kanziが空では登録できない" do
        @user.first_name_kanzi = ""
        @user.valid?
        expect(@user.errors.full_messages).to include("First_name_kanzi can't be blank")
      end
